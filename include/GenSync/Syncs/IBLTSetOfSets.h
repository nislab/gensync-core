 ...
 */
#ifndef GENSYNCLIB_IBLTSetOfSets_H
#define GENSYNCLIB_IBLTSetOfSets_H
...
public:
  ...
  **/
   ...
   */
  template <class T>
  static void postProcessing_IBLTSetOfSets(list<shared_ptr<DataObject>> otherMinusSelf, const DataContainer& myData, void (T::*add)(shared_ptr<DataObject>), bool (T::*del)(shared_ptr<DataObject>), T *pGenSync)
  {
